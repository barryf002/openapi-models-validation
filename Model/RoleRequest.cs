...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RoleRequest : IEquatable<RoleRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public RoleRequest(string name = default(string), List<string> requiredFields = default(List<string>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RoleRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "requiredFields" is required (not null)
            if (requiredFields == null)
            {
                throw new ArgumentNullException("requiredFields is a required property for RoleRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as RoleRequest);
        }

        /// <summary>
        /// Returns true if RoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleRequest input)
        {
            if (input == null)
            {
                return false;
