...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Role : IEquatable<Role>, IValidatableObject
    {
        ...
        public Role(string id = default(string), string name = default(string), List<string> requiredFields = default(List<string>))
        {
            ...
            {
                throw new ArgumentNullException("requiredFields is a required property for Role and cannot be null");
            }
