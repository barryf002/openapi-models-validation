...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetworkServiceRequest")]
    [JsonConverter(typeof(JsonSubtypes), "Type")]
    [JsonSubtypes.KnownSubType(typeof(CloudNetworkServiceRequest), "cloud_vc")]
    [JsonSubtypes.KnownSubType(typeof(P2PNetworkServiceRequest), "p2p_vc")]
    public partial class NetworkServiceRequest : IEquatable<NetworkServiceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkServiceRequest" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        public NetworkServiceRequest(string type = default(string))
        {
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetworkServiceRequest {\n");
        ...
        {
            return this.Equals(input as NetworkServiceRequest);
        }

        /// <summary>
        /// Returns true if NetworkServiceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkServiceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkServiceRequest input)
        {
            if (input == null)
            {
                return false;
