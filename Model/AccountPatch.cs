...
namespace Org.OpenAPITools.Model
{
    ...
    /// Account Update
    /// </summary>
    [DataContract(Name = "AccountPatch")]
    public partial class AccountPatch : IEquatable<AccountPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPatch" /> class.
        /// </summary>
        ...
        /// <param name="metroAreaNetworkPresence">Informal list of &#x60;MetroAreaNetwork&#x60; ids, indicating the presence to other accounts. The list is maintained by the account and can be empty. .</param>
        /// <param name="name">Name of the account, how it gets represented in e.g. a \&quot;customers list\&quot;. .</param>
        public AccountPatch(Address address = default(Address), BillingInformation billingInformation = default(BillingInformation), bool discoverable = false, string externalRef = default(string), string legalName = default(string), string managingAccount = default(string), List<string> metroAreaNetworkPresence = default(List<string>), string name = default(string))
        {
        ...
        [DataMember(Name = "metro_area_network_presence", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as AccountPatch);
        }

        /// <summary>
        /// Returns true if AccountPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountPatch input)
        {
            if (input == null)
            {
                return false;
