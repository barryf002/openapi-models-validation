...
namespace Org.OpenAPITools.Model
{
    ...
    /// Role Update
    /// </summary>
    [DataContract(Name = "RoleUpdate")]
    public partial class RoleUpdate : IEquatable<RoleUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="requiredFields">A list of required field names.  (required).</param>
        public RoleUpdate(string name = default(string), List<string> requiredFields = default(List<string>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RoleUpdate and cannot be null");
            }
            this.Name = name;
            // to ensure "requiredFields" is required (not null)
            if (requiredFields == null)
            {
                throw new ArgumentNullException("requiredFields is a required property for RoleUpdate and cannot be null");
            }
        ...
        [DataMember(Name = "required_fields", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as RoleUpdate);
        }

        /// <summary>
        /// Returns true if RoleUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleUpdate input)
        {
            if (input == null)
            {
                return false;
