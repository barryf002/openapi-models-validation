...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Contact : IEquatable<Contact>, IValidatableObject
    {
        ...
        public Contact(string consumingAccount = default(string), string email = default(string), string externalRef = default(string), string id = default(string), string managingAccount = default(string), string name = default(string), string telephone = default(string))
        {
            // to ensure "consumingAccount" is required (not null)
            if (consumingAccount == null)
            {
                throw new ArgumentNullException("consumingAccount is a required property for Contact and cannot be null");
            }
            this.ConsumingAccount = consumingAccount;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Contact and cannot be null");
            }
            this.Id = id;
            // to ensure "managingAccount" is required (not null)
            if (managingAccount == null)
            {
                throw new ArgumentNullException("managingAccount is a required property for Contact and cannot be null");
            }
