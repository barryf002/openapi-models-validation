...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NetworkService")]
    [JsonConverter(typeof(JsonSubtypes), "Type")]
    [JsonSubtypes.KnownSubType(typeof(CloudNetworkService), "cloud_vc")]
    [JsonSubtypes.KnownSubType(typeof(P2PNetworkService), "p2p_vc")]
    public partial class NetworkService : IEquatable<NetworkService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkService" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        public NetworkService(string type = default(string))
        {
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as NetworkService);
        }

        /// <summary>
        /// Returns true if NetworkService instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkService input)
        {
            if (input == null)
            {
                return false;
