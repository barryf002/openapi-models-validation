...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoleAssignment")]
    public partial class RoleAssignment : IEquatable<RoleAssignment>, IValidatableObject
    {
        /// <summary>
        ...
        public RoleAssignment(string contact = default(string), string id = default(string), string role = default(string))
        {
            // to ensure "contact" is required (not null)
            if (contact == null)
            {
                throw new ArgumentNullException("contact is a required property for RoleAssignment and cannot be null");
            }
            this.Contact = contact;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for RoleAssignment and cannot be null");
            }
            this.Id = id;
            // to ensure "role" is required (not null)
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for RoleAssignment and cannot be null");
            }
            this.Role = role;
        }
        ...
        {
            return this.Equals(input as RoleAssignment);
        }

        /// <summary>
        /// Returns true if RoleAssignment instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleAssignment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleAssignment input)
        {
            if (input == null)
            {
                return false;
