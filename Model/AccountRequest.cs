...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AccountRequest : IEquatable<AccountRequest>, IValidatableObject
    {
        ...
        public AccountRequest(Address address = default(Address), BillingInformation billingInformation = default(BillingInformation), bool discoverable = false, string externalRef = default(string), string legalName = default(string), string managingAccount = default(string), List<string> metroAreaNetworkPresence = default(List<string>), string name = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for AccountRequest and cannot be null");
            }
            this.Address = address;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AccountRequest and cannot be null");
            }
            this.Name = name;
