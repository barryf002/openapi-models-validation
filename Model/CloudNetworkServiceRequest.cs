...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CloudNetworkServiceRequest")]
    public partial class CloudNetworkServiceRequest : NetworkServiceRequest, IEquatable<CloudNetworkServiceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudNetworkServiceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public CloudNetworkServiceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudNetworkServiceRequest" /> class.
        /// </summary>
        ...
        /// <param name="type">type (default to &quot;CloudNetworkServiceRequest&quot;).</param>
        public CloudNetworkServiceRequest(string billingAccount = default(string), int? capacity = default(int?), string cloudKey = default(string), string consumingAccount = default(string), string contractRef = default(string), string externalRef = default(string), string managingAccount = default(string), string purchaseOrder = @"", string type = @"CloudNetworkServiceRequest") : base(type)
        {
            // to ensure "billingAccount" is required (not null)
            if (billingAccount == null)
            {
                throw new ArgumentNullException("billingAccount is a required property for CloudNetworkServiceRequest and cannot be null");
            }
            this.BillingAccount = billingAccount;
            // to ensure "cloudKey" is required (not null)
            if (cloudKey == null)
            {
                throw new ArgumentNullException("cloudKey is a required property for CloudNetworkServiceRequest and cannot be null");
            }
            this.CloudKey = cloudKey;
            // to ensure "consumingAccount" is required (not null)
            if (consumingAccount == null)
            {
                throw new ArgumentNullException("consumingAccount is a required property for CloudNetworkServiceRequest and cannot be null");
            }
            this.ConsumingAccount = consumingAccount;
            // to ensure "managingAccount" is required (not null)
            if (managingAccount == null)
            {
                throw new ArgumentNullException("managingAccount is a required property for CloudNetworkServiceRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloudNetworkServiceRequest {\n");
        ...
        {
            return this.Equals(input as CloudNetworkServiceRequest);
        }

        /// <summary>
        /// Returns true if CloudNetworkServiceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CloudNetworkServiceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloudNetworkServiceRequest input)
        {
            if (input == null)
            {
                return false;
