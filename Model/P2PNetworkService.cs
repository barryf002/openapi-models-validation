...
namespace Org.OpenAPITools.Model
{
    ...
    /// P2P Network Service
    /// </summary>
    [DataContract(Name = "P2PNetworkService")]
    public partial class P2PNetworkService : NetworkService, IEquatable<P2PNetworkService>, IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        /// <param name="type">type (default to &quot;P2PNetworkService&quot;).</param>
        public P2PNetworkService(string billingAccount = default(string), int? capacity = default(int?), DateTime chargedUntil = default(DateTime), string consumingAccount = default(string), string contractRef = default(string), DateTime currentBillingStartDate = default(DateTime), DateTime decommissionAt = default(DateTime), string displayName = default(string), string externalRef = default(string), string id = default(string), string managingAccount = default(string), string purchaseOrder = @"", StateEnum state = default(StateEnum), List<Status> status = default(List<Status>), string type = @"P2PNetworkService") : base(type)
        {
            // to ensure "billingAccount" is required (not null)
            if (billingAccount == null)
            {
                throw new ArgumentNullException("billingAccount is a required property for P2PNetworkService and cannot be null");
            }
            this.BillingAccount = billingAccount;
            // to ensure "consumingAccount" is required (not null)
            if (consumingAccount == null)
            {
                throw new ArgumentNullException("consumingAccount is a required property for P2PNetworkService and cannot be null");
            }
            this.ConsumingAccount = consumingAccount;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for P2PNetworkService and cannot be null");
            }
            this.Id = id;
            // to ensure "managingAccount" is required (not null)
            if (managingAccount == null)
            {
                throw new ArgumentNullException("managingAccount is a required property for P2PNetworkService and cannot be null");
            }
