...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ContactRequest : IEquatable<ContactRequest>, IValidatableObject
    {
        ...
        public ContactRequest(string consumingAccount = default(string), string email = default(string), string externalRef = default(string), string managingAccount = default(string), string name = default(string), string telephone = default(string))
        {
            // to ensure "consumingAccount" is required (not null)
            if (consumingAccount == null)
            {
                throw new ArgumentNullException("consumingAccount is a required property for ContactRequest and cannot be null");
            }
            this.ConsumingAccount = consumingAccount;
            // to ensure "managingAccount" is required (not null)
            if (managingAccount == null)
            {
                throw new ArgumentNullException("managingAccount is a required property for ContactRequest and cannot be null");
            }
