...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Account : IEquatable<Account>, IValidatableObject
    {
        ...
        public Account(Address address = default(Address), BillingInformation billingInformation = default(BillingInformation), bool discoverable = false, string externalRef = default(string), string id = default(string), string legalName = default(string), string managingAccount = default(string), List<string> metroAreaNetworkPresence = default(List<string>), string name = default(string), StateEnum? state = default(StateEnum?), List<Status> status = default(List<Status>))
        {
            ...
            {
                throw new ArgumentNullException("metroAreaNetworkPresence is a required property for Account and cannot be null");
            }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // Id (string) maxLength
            if (this.Id != null && this.Id.Length > 80)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Id, length must be less than 80.", new [] { "Id" });
            }
