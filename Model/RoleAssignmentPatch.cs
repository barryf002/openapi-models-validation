...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoleAssignmentPatch")]
    public partial class RoleAssignmentPatch : IEquatable<RoleAssignmentPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleAssignmentPatch" /> class.
        /// </summary>
        /// <param name="contact">The &#x60;id&#x60; of a contact the role is assigned to. .</param>
        /// <param name="role">The &#x60;id&#x60; of a role the contact is assigned to. .</param>
        public RoleAssignmentPatch(string contact = default(string), string role = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoleAssignmentPatch {\n");
        ...
        {
            return this.Equals(input as RoleAssignmentPatch);
        }

        /// <summary>
        /// Returns true if RoleAssignmentPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleAssignmentPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleAssignmentPatch input)
        {
            if (input == null)
            {
                return false;
