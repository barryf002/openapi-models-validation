...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoleAssignmentRequest")]
    public partial class RoleAssignmentRequest : IEquatable<RoleAssignmentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public RoleAssignmentRequest(string contact = default(string), string role = default(string))
        {
            // to ensure "contact" is required (not null)
            if (contact == null)
            {
                throw new ArgumentNullException("contact is a required property for RoleAssignmentRequest and cannot be null");
            }
            this.Contact = contact;
            // to ensure "role" is required (not null)
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for RoleAssignmentRequest and cannot be null");
            }
            this.Role = role;
        }
        ...
        {
            return this.Equals(input as RoleAssignmentRequest);
        }

        /// <summary>
        /// Returns true if RoleAssignmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleAssignmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleAssignmentRequest input)
        {
            if (input == null)
            {
                return false;
